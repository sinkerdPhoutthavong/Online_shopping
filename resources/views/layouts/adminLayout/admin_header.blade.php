...
<div id="header">
  ...
  <div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
      ...
      <li class="dropdown" id="menu-messages"><a href="#" data-toggle="dropdown" data-target="#menu-messages" class="dropdown-toggle"><i class="icon icon-envelope"></i> <span class="text">ຂໍ້ຄວາມ</span> <span class="label label-important">5</span> <b class="caret"></b></a>
        <ul class="dropdown-menu">
