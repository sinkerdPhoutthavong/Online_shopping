        ...
        <form id="loginform" class="form-vertical" method ="post" action="{{url('admin')}}">
           {{csrf_field()}}
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-left"><a href="#" class="flip-link btn btn-info" id="to-recover">ລືມລະຫັດຜ່ານ?</a></span>
            ...
            <form id="recoverform" action="#" class="form-vertical">
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="#" class="flip-link btn btn-success" id="to-login">&laquo; ກັບສູ່ໜ້າລ໋ອກອິນ</a></span>
                    <span class="pull-right"><a class="btn btn-info"/>ກູ້ລະຫັດຜ່ານ</a></span></font>
                </div>
            </form>
        </div>
